            ...
            <div
                className="flex flex-col lg:flex-row lg:w-7/12 xl:w-7/12 xl:flex-row justify-center items-center w-11/12 h-32 rounded-md bg-indigo-500 ...">
                {
                    ...
                    <div className="flex flex-col p-2 lg:p-4 xl:p-4">
                        <h3 className="text-2xl font-extrabold text-white">Horário Agendado.</h3>
                ...
                }
                {
                    !isCompleted &&
                    <div className="flex flex-col p-2 lg:p-4 xl:p-4">
                        <h3 className="text-2xl font-extrabold text-white">Faça uma Reserva</h3>
                ...
                }
                {
                    ...
                    <div className="flex p-2 lg:p-4 xl:p-4 items-center">
                        ...
                        <button
                            className="w-32 h-10 text-sm font-extrabold text-white bg-blue-400 rounded-md hover:bg-blue-500"
